...
static ohcp_string* and_to_str(const ohcp_expr* expr)
{
    (void) expr;
...
static ohcp_string* and_to_asgn_str(const ohcp_expr* expr)
{
    ohcp_string* str;
...
static ohcp_expr_descr and_descr = {
    .name = "and",
    .to_str = and_to_str,
    .to_asgn_str = and_to_asgn_str
};

ohcp_node* ohcp_expr_and(size_t in_count, const ohcp_node* in_list [])
{
    ...
    do {
        ...
        do {
            ...
            do {
                ...
                do {
                    expr = ohcp_expr_create(&and_descr, param_list, input_list, output);
                    if (expr == NULL) {
                        char    buf [1024];
                        int     ret;
                        size_t  len;
...
// ohcp_node* ohcp_expr_andq(ohcp_deque* input_list)
// {
//     ohcp_deque* param_list;
//     ohcp_node* output;
//     ohcp_expr* expr;
...
ohcp_node* ohcp_expr_and2(const ohcp_node* node0, const ohcp_node* node1)
{
    ...
    return ohcp_expr_and(2, in_list);
}

ohcp_node* ohcp_expr_and3(const ohcp_node* node0, const ohcp_node* node1,
    const ohcp_node* node2)
{
    ...
    return ohcp_expr_and(3, in_list);
}

ohcp_node* ohcp_expr_and4(const ohcp_node* node0, const ohcp_node* node1,
    const ohcp_node* node2, const ohcp_node* node3)
{
    ...
    return ohcp_expr_and(4, in_list);
}

// -------------------------------------------------------------------------- //

static ohcp_string* red_and_to_str(const ohcp_expr* expr)
{
    (void) expr;
...
static ohcp_string* red_and_to_asgn_str(const ohcp_expr* expr)
{
    ohcp_string* str;
...
static ohcp_expr_descr red_and_descr = {
    .name = "redand",
    .to_str = red_and_to_str,
    .to_asgn_str = red_and_to_asgn_str
};

ohcp_node* ohcp_expr_red_and(const ohcp_node* in_vec)
{
    const ohcp_type* out_type;
    ohcp_deque* param_list;
    ohcp_deque* input_list;
    ...
    do {
        ...
        do {
            ...
            do {
                ...
                do {
                    expr = ohcp_expr_create(&red_and_descr, param_list, input_list, output);
                    if (expr == NULL) {
                        char    buf [1024];
                        int     ret;
                        size_t  len;
