...
static ohcp_string* inv_to_str(/* ref */ const ohcp_expr* expr)
{
    (void) expr;
...
static ohcp_string* inv_to_asgn_str(/* ref */ const ohcp_expr* expr)
{
    ohcp_string* str;
...
static ohcp_expr_descr inv_descr = {
    .name = "inv",
    .to_str = inv_to_str,
    .to_asgn_str = inv_to_asgn_str
};

ohcp_node* ohcp_expr_inv(ohcp_node* node)
{
    ...
    do {
        ...
        do {
            ...
            do {
                ...
                do {
                    expr = ohcp_expr_create(&inv_descr, param_list, input_list, output);
                    if (expr == NULL) {
                        char    buf [1024];
                        int     ret;
                        size_t  len;
