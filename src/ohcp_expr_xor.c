...
static ohcp_string* xor_to_str(const ohcp_expr* expr)
{
    (void) expr;
...
static ohcp_string* xor_to_asgn_str(const ohcp_expr* expr)
{
    ohcp_string* str;
...
static ohcp_expr_descr xor_descr = {
    .name = "xor",
    .to_str = xor_to_str,
    .to_asgn_str = xor_to_asgn_str
};

ohcp_node* ohcp_expr_xor(size_t in_count, const ohcp_node* in_list [])
{
    ...
    do {
        ...
        do {
            ...
            do {
                ...
                do {
                    expr = ohcp_expr_create(&xor_descr, param_list, input_list, output);
                    if (expr == NULL) {
                        char    buf [1024];
                        int     ret;
                        size_t  len;
...
// ohcp_node* ohcp_expr_xorq(ohcp_deque* input_list)
// {
//     ohcp_deque* param_list;
//     ohcp_node* output;
//     ohcp_expr* expr;
...
ohcp_node* ohcp_expr_xor2(const ohcp_node* node0, const ohcp_node* node1)
{
    ...
    return ohcp_expr_xor(2, in_list);
}

ohcp_node* ohcp_expr_xor3(const ohcp_node* node0, const ohcp_node* node1,
    const ohcp_node* node2)
{
    ...
    return ohcp_expr_xor(3, in_list);
}

ohcp_node* ohcp_expr_xor4(const ohcp_node* node0, const ohcp_node* node1,
    const ohcp_node* node2, const ohcp_node* node3)
{
    ...
    return ohcp_expr_xor(4, in_list);
}

// -------------------------------------------------------------------------- //

static ohcp_string* red_xor_to_str(const ohcp_expr* expr)
{
    (void) expr;
...
static ohcp_string* red_xor_to_asgn_str(const ohcp_expr* expr)
{
    ohcp_string* str;
...
static ohcp_expr_descr red_xor_descr = {
    .name = "redxor",
    .to_str = red_xor_to_str,
    .to_asgn_str = red_xor_to_asgn_str
};

ohcp_node* ohcp_expr_red_xor(const ohcp_node* in_vec)
{
    const ohcp_type* out_type;
    ohcp_deque* param_list;
    ohcp_deque* input_list;
    ...
    do {
        ...
        do {
            ...
            do {
                ...
                do {
                    expr = ohcp_expr_create(&red_xor_descr, param_list, input_list, output);
                    if (expr == NULL) {
                        char    buf [1024];
                        int     ret;
                        size_t  len;
